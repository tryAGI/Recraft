...
namespace Recraft
{
    public partial class ImageClient
    {
        ...
        private static readonly global::Recraft.EndPointSecurityRequirement s_GenerateImageVectorSecurityRequirement0 =
        ...
        private static readonly global::Recraft.EndPointSecurityRequirement[] s_GenerateImageVectorSecurityRequirements =
            new global::Recraft.EndPointSecurityRequirement[]
            {                s_GenerateImageVectorSecurityRequirement0,
            };
        partial void PrepareGenerateImageVectorArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Recraft.BillingType? billing,
            global::Recraft.GenerateImageJSONRequest request);
        partial void PrepareGenerateImageVectorRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Recraft.BillingType? billing,
            global::Recraft.GenerateImageJSONRequest request);
        partial void ProcessGenerateImageVectorResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGenerateImageVectorResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Generate vector image from prompt
        /// </summary>
        ...
        public async global::System.Threading.Tasks.Task<global::Recraft.GenerateImageResponse> GenerateImageVectorAsync(
        ...
        {
            var __response = await GenerateImageVectorAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Recraft.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Recraft.AutoSDKHttpResponse<global::Recraft.GenerateImageResponse>> GenerateImageVectorAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGenerateImageVectorArguments(
            ...
            var __authorizations = global::Recraft.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GenerateImageVectorSecurityRequirements,
                operationName: "GenerateImageVectorAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGenerateImageVectorRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Recraft.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Recraft.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateImageVector",
                                methodName: "GenerateImageVectorAsync",
                                pathTemplate: "\"/v1/images/generations/vector\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGenerateImageVectorResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Recraft.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGenerateImageVectorResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Recraft.GenerateImageResponse> GenerateImageVectorAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Recraft.GenerateImageJSONRequest
            {
            };

            return await GenerateImageVectorAsync(
                billing: billing,
                request: __request,
                requestOptions: requestOptions,
