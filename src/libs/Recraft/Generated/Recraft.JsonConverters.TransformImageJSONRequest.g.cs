...
{
    /// <inheritdoc />
    public class TransformImageJSONRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Recraft.TransformImageJSONRequest>
    {
        /// <inheritdoc />
        public override global::Recraft.TransformImageJSONRequest Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Recraft.TransformImageJSONRequestVariant2? transformImageJSONRequestVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Recraft.TransformImageJSONRequestVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Recraft.TransformImageJSONRequestVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Recraft.TransformImageJSONRequestVariant2).Name}");
                        transformImageJSONRequestVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (@base == null && transformImageJSONRequestVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Recraft.TransformImageJSONRequest(
                @base,
        ...
        public override void Write(
            ...
            global::Recraft.TransformImageJSONRequest value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsTransformImageJSONRequestVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Recraft.TransformImageJSONRequestVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Recraft.TransformImageJSONRequestVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Recraft.TransformImageJSONRequestVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.TransformImageJSONRequestVariant2!, typeInfo);
            }
        }
    }
}