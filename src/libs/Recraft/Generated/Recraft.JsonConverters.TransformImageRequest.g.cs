...
{
    /// <inheritdoc />
    public class TransformImageRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Recraft.TransformImageRequest>
    {
        /// <inheritdoc />
        public override global::Recraft.TransformImageRequest Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Recraft.TransformImageRequestVariant2? transformImageRequestVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Recraft.TransformImageRequestVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Recraft.TransformImageRequestVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Recraft.TransformImageRequestVariant2).Name}");
                        transformImageRequestVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (@base == null && transformImageRequestVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Recraft.TransformImageRequest(
                @base,
        ...
        public override void Write(
            ...
            global::Recraft.TransformImageRequest value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsTransformImageRequestVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Recraft.TransformImageRequestVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Recraft.TransformImageRequestVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Recraft.TransformImageRequestVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.TransformImageRequestVariant2!, typeInfo);
            }
        }
    }
}